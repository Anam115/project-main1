...
<header class="sticky top-0 bg-green-700 text-white p-4">
  <div class="container mx-auto flex justify-between items-center">
    ...
    <nav class="space-x-4">
      ...
      <a href="players.php" class="hover:underline  underline">Players</a>
  ...
  fetch('search_players.php?query=' + encodeURIComponent(query))
    ...
    .then(data => {
      ...
      data.forEach(player => {
        playerCards.innerHTML += `
          <div class="bg-white shadow-md rounded-lg p-4 text-center">
            <img src="images/${player.image}" class="w-24 h-24 mx-auto rounded-full mb-2" alt="${player.name}">
...
// ⛔ No real-time fetch; only on Enter or button click
