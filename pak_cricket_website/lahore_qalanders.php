...
<!-- ✅ Navbar -->
<header class="sticky top-0 bg-black text-yellow-400">
  <div class="container mx-auto flex justify-between items-center px-4 py-4">
    <h1 class="text-2xl font-bold">🟡 Peshawar Zalmi Squad</h1>
    <nav class="space-x-4">
...
<div class="max-w-7xl mx-auto px-4 py-10">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
    ...
    <div class="card bg-white rounded-lg shadow-md hover:shadow-xl transition">
      <img src="images/<?= $player['image'] ?>" alt="<?= $player['name'] ?>" class="w-full h-72 object-cover rounded-lg">
      <div class="overlay">
